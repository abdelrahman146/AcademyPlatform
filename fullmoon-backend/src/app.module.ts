...
import { CartItem } from './modules/user/entities/cartitem.entity';
import { User } from './modules/user/entities/user.entity';
import { WishlistItem } from './modules/user/entities/wishlistitem.entity';
...
@Module({
  imports: [
    SequelizeModule.forRoot({
      ...
      autoLoadModels: true,
      synchronize: true,
      models: [Attendance, Answer, Category, Course, Enrollment, Section, SubCategory, Lecture, Option, Question, Quiz, CartItem, User, WishlistItem],
    }),
